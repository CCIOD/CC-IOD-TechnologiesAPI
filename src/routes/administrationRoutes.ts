...
import { getPaymentsByClient, createPayment, updatePayment, deletePayment } from '../controllers/paymentsController';
import {
...
import { getFilesByClient, uploadFile, deleteFile } from '../controllers/filesController';
import { getDashboardSummary, getPaymentMetrics } from '../controllers/dashboardController';
