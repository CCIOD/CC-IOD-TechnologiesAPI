...
import {
  ...
  updateRenewalDocument,
} from '../controllers/clientController';
import { errorMiddleware } from '../middlewares/errorMiddleware';
import { validationFiles } from '../middlewares/validationFiles';
import { uploadContractFile, uploadRenewalFile } from '../middlewares/uploadFiles';
...
router.put('/:id/renovar-contrato', uploadRenewalFile, renewContractEndpoint);
router.patch('/:id/renovaciones/:renewal_id', uploadRenewalFile, updateRenewalDocument);
